...
const FlipDown = (function () {
  ...
  _createClass(FlipDown, [{
    ...
    value: function _parseOptions (opt) {
      let headings = ['Days', 'Horas', 'Minutos', 'Segundos']
    ...
    value: function _createRotor () {
      const v = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0
    ...
    value: function _updateClockValues () {
      ...
      const init = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false
